...
AIAutoUpdate(*) {
    ...
    URL_SCRIPT := "https://github.com/WoahItsJeebus/Roblox-Anti-AFK/releases/latest"
    tempFile := A_Temp "\temp_script.ahk"
    
    ; Step 1: Create a Progress GUI
    local progressGui := Gui("AlwaysOnTop")
    ...
    statusText := progressGui.Add("Text", "x10 y70 w300 h20", "Checking for updates...")
...
ClickRobloxWindows(process)
{
	...
	if not wasActiveWindow and WinExist(process)
		WinActivate(process)
